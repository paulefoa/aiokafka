/*
 * Copied from `librdkafka` project with minor modifications:
 *  * Removed unit tests
 *  * Removed RD specific prefixes and includes
 * 
 *
 * Original document:
 * https://github.com/edenhill/librdkafka/blob/master/src/crc32c.c
 */
